...
extern int win_textgrid_unputchar(window_t *win, char ch);
...
extern int win_textbuffer_unputchar(window_t *win, char ch);
...
extern int gli_window_unput_char(window_t *win, char ch);
